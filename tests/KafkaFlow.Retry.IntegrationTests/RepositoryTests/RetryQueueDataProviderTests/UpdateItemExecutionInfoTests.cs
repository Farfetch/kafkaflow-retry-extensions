...
public class UpdateItemExecutionInfoTests : RetryQueueDataProviderTestsTemplate
{
    ...
    public async Task UpdateItemExecutionInfoAsync_UpdateStatus_ReturnsUpdatedStatus(RepositoryType repositoryType,
        RetryQueueItemStatus expectedItemStatus)
    {
        // Arrange
        ...
        var input = new UpdateItemExecutionInfoInput(queue.Id, item.Id, expectedItemStatus, expectedAttemptsCount,
            expectedLastExecution, expectedDescription);
    ...
    public async Task UpdateItemExecutionInfoAsync_UpdateToDone_QueueWithoutAllItemsDone_ReturnsUpdatedStatus(
        RepositoryType repositoryType)
    {
        ...
        var input = new UpdateItemExecutionInfoInput(queue.Id, firstItem.Id, expectedItemStatus, expectedAttemptsCount,
            expectedLastExecution, expectedDescription);
    ...
    [InlineData(RepositoryType.SqlServer)]
    [InlineData(RepositoryType.Postgres)]
    public async Task UpdateItemExecutionInfoAsync_UpdateToDone_ReturnsUpdatedStatusQueueWithAllItemsDone(
        RepositoryType repositoryType)
    {
        // Arrange
        var repository = GetRepository(repositoryType);
    ...
    public async Task UpdateItemExecutionInfoAsync_WrongItem_ReturnsItemNotFoundStatus(RepositoryType repositoryType)
    {
        ...
        var input = new UpdateItemExecutionInfoInput(queue.Id, notExpectedItemId, notExpectedItemStatus,
            notExpectedAttemptsCount, notExpectedLastExecution, expectedDescription);
    ...
    [InlineData(RepositoryType.Postgres, RetryQueueItemStatus.Waiting)]
    public async Task UpdateItemExecutionInfoAsync_WrongQueue_ReturnsQueueNotFoundStatus(RepositoryType repositoryType,
        RetryQueueItemStatus notExpectedItemStatus)
    {
        // Arrange
        var repository = GetRepository(repositoryType);
        ...
        var input = new UpdateItemExecutionInfoInput(wrongQueueId, item.Id, notExpectedItemStatus,
            notExpectedAttemptsCount, notExpectedLastExecution, expectedDescription);
