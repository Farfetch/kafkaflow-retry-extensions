...
internal static class BootstrapperKafka
{
    ...
    private static readonly string[] s_testTopics =
    {
                            ...
                            .RetryDurable(
                                configure => configure
                                    ...
                                    .WithPollingJobsConfiguration(
                                        configure => configure
                                            .WithSchedulerId(
                                                "custom_search_key_durable_guarantee_ordered_consumption_mongo_db")
        ...
        cluster
            ...
            .AddConsumer(
                consumer => consumer
                    ...
                    .WithGroupId(
                        "test-consumer-kafka-flow-retry-retry-durable-guarantee-ordered-consumption-sql-server")
                    .WithBufferSize(100)
                    .WithWorkersCount(10)
                    .WithAutoOffsetReset(AutoOffsetReset.Latest)
                    .AddMiddlewares(
                            ...
                            .RetryDurable(
                                configure => configure
                                    ...
                                    .WithPollingJobsConfiguration(
                                        configure => configure
                                            .WithSchedulerId(
                                                "custom_search_key_durable_guarantee_ordered_consumption_sql_server")
                                            .WithRetryDurablePollingConfiguration(
                                                configure => configure
                                                    .Enabled(true)
                                                    .WithCronExpression("0/30 * * ? * * *")
                            ...
                            .RetryDurable(
                                configure => configure
                                    ...
                                    .WithPollingJobsConfiguration(
                                        configure => configure
                                            .WithSchedulerId(
                                                "custom_search_key_durable_guarantee_ordered_consumption_postgres")
                                            .WithRetryDurablePollingConfiguration(
                                                configure => configure
                                                    .Enabled(true)
                                                    .WithCronExpression("0/30 * * ? * * *")
